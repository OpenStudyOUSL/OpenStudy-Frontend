      ...
      <div className="relative mx-auto max-w-6xl px-6 py-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 items-center min-h-[120px]">
          ...
          <div className="flex flex-col justify-center h-full">
            ...
            {/* Accent badge (narrow width) */}
            <div className="mt-4 inline-flex items-center gap-2 w-fit rounded-full border border-red-300 bg-red-100 px-2.5 py-1 text-xs font-semibold text-red-900">
